!function() {
    ...
    e.modules = {}, e.aliases = {}, e.resolve = function(t) {
        ...
        (function() {
            var e, n, r, s, o, l, a = {}.hasOwnProperty, u = function(e, t) {
                function i() {
                    this.constructor = e
                }
                for (var n in t)
            ...
            n = "undefined" != typeof Emitter && null !== Emitter ? Emitter : t("emitter"), o = function() {
                ...
                function t(e, n) {
                    ...
                    if (t.instances.push(this), e.dropzone = this, r = null != (o = t.optionsForElement(this.element)) ? o : {}, this.options = i({}, this.defaultOptions, r, null != n ? n : {}), this.options.forceFallback || !t.isBrowserSupported())
                ...
                return u(t, e), t.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "selectedfiles", "addedfile", "removedfile", "thumbnail", "error", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded"], t.prototype.defaultOptions = {url: null, method: "post", withCredentials: !1, parallelUploads: 2, uploadMultiple: !1, maxFilesize: 256, paramName: "file", createImageThumbnails: !0, maxThumbnailFilesize: 10, thumbnailWidth: 100, thumbnailHeight: 100, maxFiles: null, params: {}, clickable: !0, ignoreHiddenFiles: !0, acceptedFiles: null, acceptedMimeTypes: null, autoProcessQueue: !0, addRemoveLinks: !1, previewsContainer: null, dictDefaultMessage: "Drop files here to upload", dictFallbackMessage: "Your browser does not support drag'n'drop file uploads.", dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.", dictFileTooBig: "File is too big ({{filesize}}MB). Max filesize: {{maxFilesize}}MB.", dictInvalidFileType: "You can't upload files of this type.", dictResponseError: "Server responded with {{statusCode}} code.", dictCancelUpload: "Cancel upload", dictCancelUploadConfirmation: "Are you sure you want to cancel this upload?", dictRemoveFile: "Remove file", dictRemoveFileConfirmation: null, dictMaxFilesExceeded: "You can only upload {{maxFiles}} files.", accept: function(e, t) {
                    ...
                    }, processingmultiple: o, uploadprogress: function(e, t) {
                        return e.previewElement.querySelector("[data-dz-uploadprogress]").style.width = "" + t + "%"
                    }, totaluploadprogress: o, sending: o, sendingmultiple: o, success: function(e) {
                        return e.previewElement.classList.add("dz-success")
                    }, successmultiple: o, canceled: function(e) {
                        return this.emit("error", e, "Upload canceled.")
                    }, canceledmultiple: o, complete: function(e) {
                        return e._removeLink ? e._removeLink.textContent = this.options.dictRemoveFile : void 0
                    }, completemultiple: o, maxfilesexceeded: o, previewTemplate: '<div class="dz-preview dz-file-preview">\n  <div class="dz-details">\n    <div class="dz-filename"><span data-dz-name></span></div>\n    <div class="dz-size" data-dz-size></div>\n    <img data-dz-thumbnail />\n  </div>\n  <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress></span></div>\n  <div class="dz-success-mark"><span>✔</span></div>\n  <div class="dz-error-mark"><span>✘</span></div>\n  <div class="dz-error-message"><span data-dz-errormessage></span></div>\n</div>'}, i = function() {
                    var e, t, i, n, r, s, o;
                    ...
                    var e, i, n, r, s;
                    for (r = this.files, s = [], i = 0, n = r.length; n > i; i++)
                        e = r[i], e.status === t.QUEUED && s.push(e);
                    return s
                }, t.prototype.getUploadingFiles = function() {
                    var e, i, n, r, s;
                    for (r = this.files, s = [], i = 0, n = r.length; n > i; i++)
                        e = r[i], e.status === t.UPLOADING && s.push(e);
                    return s
                    ...
                    }, n()), this.URL = null != (o = window.URL)?o:window.webkitURL, l = this.events, r = 0, s = l.length; s > r; r++)
                    ...
                    return this.on("uploadprogress", function() {
                        ...
                        return a.listeners.push({element: e, events: {click: function(i) {
                    ...
                    if (n = 0, i = 0, e = this.getAcceptedFiles(), e.length) {
                        for (l = this.getAcceptedFiles(), s = 0, o = l.length; o > s; s++)
                            t = l[s], n += t.upload.bytesSent, i += t.upload.total;
                        r = 100 * n / i
                    } else
                        r = 100;
                    ...
                    for (n = 0, r = e.length; r > n; n++)
                        i = e[n], null != i.webkitGetAsEntry ? (t = i.webkitGetAsEntry(), t.isFile ? this.addFile(i.getAsFile()) : t.isDirectory && this.addDirectory(t, t.name)) : this.addFile(i.getAsFile())
                    ...
                    var i = this;
                    return e.upload = {progress: 0, total: e.size, bytesSent: 0}, this.files.push(e), e.status = t.ADDED, this.emit("addedfile", e), this.options.createImageThumbnails && e.type.match(/image.*/) && e.size <= 1024 * 1024 * this.options.maxThumbnailFilesize && this.createThumbnail(e), this.accept(e, function(t) {
                    ...
                    var i = this;
                    if (e.accepted = !0, e.status !== t.ADDED)
                    ...
                    return i = e.createReader(), n = function(i) {
                        ...
                        for (n = 0, s = i.length; s > n; n++)
                            e = i[n], e.isFile ? e.file(function(e) {
                    ...
                    var i, n, r, s;
                    for (null == e && (e = !1), s = this.files.slice(), n = 0, r = s.length; r > n; n++)
                    ...
                    if (e.status === t.UPLOADING) {
                        for (n = this._getFilesWithXhr(e.xhr), r = 0, o = n.length; o > r; r++)
                            i = n[r], i.status = t.CANCELED;
                        for (e.xhr.abort(), s = 0, l = n.length; l > s; s++)
                            i = n[s], this.emit("canceled", i);
                        this.options.uploadMultiple && this.emit("canceledmultiple", n)
                    } else
                        ((a = e.status) === t.ADDED || a === t.QUEUED) && (e.status = t.CANCELED, this.emit("canceled", e), this.options.uploadMultiple && this.emit("canceledmultiple", [e]));
                    ...
                    for (g = new XMLHttpRequest, y = 0, w = e.length; w > y; y++)
                        n = e[y], n.xhr = g;
                    g.open(this.options.method, this.options.url, !0), g.withCredentials = !!this.options.withCredentials, m = null, s = function() {
                        ...
                        for (r = [], t = 0, i = e.length; i > t; t++)
                            n = e[t], r.push(T._errorProcessing(e, m || T.options.dictResponseError.replace("{{statusCode}}", g.status), g));
                        return r
                    }, f = function(t) {
                        var i, r, s, o, l, a, u, p, d;
                        if (null != t)
                            for (r = 100 * t.loaded / t.total, s = 0, a = e.length; a > s; s++)
                                n = e[s], n.upload = {progress: r, total: t.total, bytesSent: t.loaded};
                        else {
                            for (i = !0, r = 100, o = 0, u = e.length; u > o; o++)
                                n = e[o], (100 !== n.upload.progress || n.upload.bytesSent !== n.upload.total) && (i = !1), n.upload.progress = r, n.upload.bytesSent = n.upload.total;
                            if (i)
                                return
                        }
                        for (d = [], l = 0, p = e.length; p > l; l++)
                            n = e[l], d.push(T.emit("uploadprogress", n, r, n.upload.bytesSent));
                        return d
                    }, g.onload = function(i) {
                        var n;
                        if (e[0].status !== t.CANCELED && 4 === g.readyState) {
                            if (m = g.responseText, g.getResponseHeader("content-type") && ~g.getResponseHeader("content-type").indexOf("application/json"))
                                try {
                                    m = JSON.parse(m)
                                } catch (r) {
                    ...
                    }, h = null != (k = g.upload) ? k : g, h.onprogress = f, a = {Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest"}, this.options.headers && i(a, this.options.headers);
                    for (o in a)
                        l = a[o], g.setRequestHeader(o, l);
                    if (r = new FormData, this.options.params) {
                        C = this.options.params;
                        for (c in C)
                            v = C[c], r.append(c, v)
                    }
                    for (F = 0, z = e.length; z > F; F++)
                        n = e[F], this.emit("sending", n, g, r);
                    if (this.options.uploadMultiple && this.emit("sendingmultiple", e, g, r), "FORM" === this.element.tagName)
                        for (D = this.element.querySelectorAll("input, textarea, select, button"), E = 0, x = D.length; x > E; E++)
                            u = D[E], p = u.getAttribute("name"), d = u.getAttribute("type"), (!d || "checkbox" !== (A = d.toLowerCase()) && "radio" !== A || u.checked) && r.append(p, u.value);
                    for (b = 0, L = e.length; L > b; b++)
                        n = e[b], r.append("" + this.options.paramName + (this.options.uploadMultiple ? "[]" : ""), n, n.name);
                    return g.send(r)
                ...
                if (e instanceof Array) {
                    ...
                    for (r = [], u = document.querySelectorAll(e), o = 0, a = u.length; a > o; o++)
                        n = u[o], r.push(n);
                else
                    null != e.nodeType && (r = [e]);
                if (null == r || !r.length)
                ...
                for (t = t.split(","), n = e.type, i = n.replace(/\/.*$/, ""), s = 0, o = t.length; o > s; s++)
                    if (r = t[s], r = r.trim(), "." === r.charAt(0)) {
                        if (-1 !== e.name.indexOf(r, e.name.length - r.length))
                            return!0
                    } else if (/\/\*$/.test(r)) {
                        if (i === r.replace(/\/.*$/, ""))
                            return!0

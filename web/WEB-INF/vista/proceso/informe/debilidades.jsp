                    ...
                    <c:when test="${fn:length(estudiantes)!= 0}">
                        <table class="table table-bordered">
                            <thead style="background-color: #ffffff;">
                                <tr>
                                    <th>Debilidades dadas por estudiantes</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${estudiantes}" var="est" varStatus="status">
                                    <tr>
                                        <td>${est.debilidades}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>   
                ...
                <c:choose>
                    <c:when test="${fn:length(docentes)!= 0}">
                        <table class="table table-bordered">
                            <thead style="background-color: #ffffff;">
                                <tr>
                                    <th>Debilidades dadas por docentes</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${docentes}" var="doc" varStatus="status">
                                    <tr>
                                        <td>${doc.debilidades}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>   
                ...
                <c:choose>
                    <c:when test="${fn:length(ipeses)!= 0}">
                        <table class="table table-bordered">
                            <thead style="background-color: #ffffff;">
                                <tr>
                                    <th>Debilidades dadas por IPS</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${ipeses}" var="ips" varStatus="status">
                                    <tr>
                                        <td>${ips.debilidades}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>   

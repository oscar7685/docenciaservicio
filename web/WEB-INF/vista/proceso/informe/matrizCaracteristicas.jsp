        ...
        <c:choose>
            <c:when test="${cum4>0}">
                <c:choose>
                    ...
                    '${caracteristica2.idCaracteristica}-${caracteristica2.nombreC}',</c:when>
                    <c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${cum>0}"> 
                                        <tr>
                                            ...
                                            <td style="text-align: left">   
                                                <a href="#detalleCaracteristica&${caracteristica.idCaracteristica}" data="${caracteristica.nombreC}">${caracteristica.nombreC}</a> 
                                            </td>

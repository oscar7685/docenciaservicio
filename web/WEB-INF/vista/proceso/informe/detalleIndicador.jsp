...
<script type="text/javascript">
    ...
    text: "" + finali2 + ""
            ...
            xAxis: {
    categories: [
            <c:forEach items="${criterio.preguntaList}" var="detalleI" varStatus="status">
                <c:choose>
                    <c:when test="${criterio.preguntaList.size()!=status.index+1}">
                    '${detalleI.idPregunta}-${detalleI.enunciado}',</c:when>
                    <c:otherwise>
                                '${detalleI.idPregunta}-${detalleI.enunciado}'
                    </c:otherwise>
                </c:choose>             
                        ...
                        <tbody>
                            <c:forEach items="${criterio.preguntaList}" var="row" varStatus="itera">
                                <tr>
                                    ...
                                    <td style="text-align: left">   
                                        <a href="#detallePregunta&${row.idPregunta}" data="${row.enunciado}">${row.enunciado}</a> 
                                    </td>
                                    <td>
